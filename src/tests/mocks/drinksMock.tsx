...
export const mockDrink16333: RecipeType[] = [
  {
    idDrink: "16333",
    idMeal: "",
    strMeal: "",
...
export const mockDrinksRec: RecipeType[] = [
  {
    idDrink: "",
    idMeal: "53086",
    strMeal: "Migas",
...
export const mockDrink178319: RecipeType[] = [
  {
    idDrink: "178319",
    idMeal: null,
    strMeal: null,
    ...
    strInstructionsES:
      "Agitar bien en una coctelera con hielo.\r\nColar en una copa de martini.",
    strInstructionsFR:
      "Bien agiter dans un shaker avec de la glace.\r\nFiltrer dans un verre à martini.",
    strInstructionsIT:
...
export const mockDrink178319Nullable: RecipeType[] = [
  {
    idDrink: "178319",
    idMeal: null,
    strMeal: null,
